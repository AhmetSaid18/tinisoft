...
using Serilog;
using Tinisoft.Notifications.API.Middleware;
...
// Infrastructure - Notifications Database
...
// Email Consumer Background Service
builder.Services.AddHostedService<Tinisoft.Infrastructure.Services.RabbitMQEmailConsumer>();
