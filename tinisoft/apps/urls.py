...
from apps.views.order import order_list_create, order_detail, order_track, order_delete, order_delete_all
...
urlpatterns = [
    ...
    path('orders/delete-all/', order_delete_all, name='order_delete_all'),  # DELETE: Hard delete ALL orders
